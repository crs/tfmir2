				...
				<div class="panel">
					...
					<table>
						...
						<tr>
							...
							<td>
								<select class="chosen_border" id="species" name="species" title="Choose species; either human or mouse" onchange="setCookie(this);">
						...
						<tr>
							...
							<td>
								...
								<option <?php echo checkOption('disease', ''); ?> value="">No disease</option>
									...
									//$str = diseaseLoader('Human');
									//if($_POST['species'] == 'Human')
										//$str='../backend/disease.txt';
									//if($_POST['species'] == 'Mouse')
										//$str='../backend/disease_Mouse.txt';
									//echo getDiseaseOptions($str);
									echo getDiseaseOptions('../backend/disease_HM.txt'); 
									?>
								</select>
						...
						<tr>
							...
							<td>
								<select style="width:400px;" title="Choose a tissue; use search field to narrow options" id="tissue" name="tissue" onchange="setCookie(this);">
								<option <?php echo checkOption('tissue', ''); ?> value="">No tissue</option>
									<?php 
									include_once('tissueFunctions.php');
									echo getTissueOptions('../backend/tissue_HM.txt'); ?>
								</select>	
							</td>
						</tr>		
						<!--done by Maryam -->	
...
<br />
						...
						<div id='tissue' title="Click to explore the disease specific interaction network" class="tissueButton resultButton inactive floating">
